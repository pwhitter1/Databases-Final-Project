...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Ted Cruz</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
			...
			<img src="https://upload.wikimedia.org/wikipedia/commons/8/87/Ted_Cruz,_official_portrait,_113th_Congress.jpg" style="height: 400px" alt="">
			<img src="RepresentativeGraphs/TedCruz/TedCruzTweet.png" style="height: 215px" hspace="40" alt="">
		    ...
		    <img src="images/TedCruzPrimary.jpg" style="width: 500px" hspace="120" alt="">
           <!--</div>-->
	      ...
	      <div class="col-md-4">
                <p>
                    ...
                    $result = mysqli_query ($conn, "select stateName from CurrentPrimaryData where winnerName='Ted Cruz' order by stateName;");
...
<?php   
                    ...
                    $result = mysqli_query ($conn, "select percentPositive,percentNegative,percentNeutral from Twitter where candidateName='Ted Cruz';");
        ...
        ?>
			...
			<img src="RepresentativeGraphs/TedCruz/twitter_sentiment_raw.png" style="width: 500px" alt="">
			<img src="RepresentativeGraphs/TedCruz/twitter_sentiment_volume.png" style="width: 500px" hspace="40" alt="">
