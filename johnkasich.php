...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">John Kasich</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
		    ...
		    <img src="images/JohnKasichPrimary.jpg" style="width: 500px" hspace="120" alt="">
           <!--</div>-->
	      ...
	      <div class="col-md-4">
                <p>
                    ...
                    $result = mysqli_query ($conn, "select stateName from CurrentPrimaryData where winnerName='John Kasich' order by stateName;");
			
 		    echo "<table border='1' style='width:100%'>";
	   	    echo "<tr><td><b>State Name</td><td><b>Electoral Votes</td><td><b>Swing State?</td></tr>";
	...
	<?php
                    ...
                    $result = mysqli_query ($conn, "select percentPositive,percentNegative,percentNeutral from Twitter where candidateName='John Kasich';");
	...
	?>
			...
			<img src="RepresentativeGraphs/JohnKasich/twitter_sentiment_raw.png" style="width: 500px" alt="">
			<img src="RepresentativeGraphs/JohnKasich/twitter_sentiment_volume.png" style="width: 500px" hspace="40" alt="">
