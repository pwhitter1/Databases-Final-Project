...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
		    ...
		    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d2/Donald_Trump_August_19,_2015_(cropped).jpg" style="height: 400px" alt="">
 		    <img src="RepresentativeGraphs/DonaldTrump/DonaldTrumpTweet.png" style="height: 265px" hspace="90" alt="">
		    ...
		    <img src="images/DonaldTrumpPrimary.jpg" style="width: 500px" hspace="120" alt="">
           <!--</div>-->
	      ...
	      <div class="col-md-4">
                <p>
                    ...
                    $result = mysqli_query ($conn, "select stateName from CurrentPrimaryData where winnerName='Donald Trump' order by stateName;");
        ...
        <div class="row">
           ...
           <?php   
                    ...
                    $result = mysqli_query ($conn, "select percentPositive,percentNegative,percentNeutral from Twitter where candidateName='Donald Trump';");
        ...
        ?>
			...
			<img src="RepresentativeGraphs/DonaldTrump/twitter_sentiment_raw.png" style="width: 500px" alt="">
			<img src="RepresentativeGraphs/DonaldTrump/twitter_sentiment_volume.png" style="width: 500px" hspace="40" alt="">
